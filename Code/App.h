...
//Use Calculator App (call from SFML.cpp)
void useCalculatorApp();

//Use Games App (call from SFML.cpp)
void useGameApp();

//Use Phone App (call from SFML.cpp)
void usePhoneApp();

//Use Text App (call from SFML.cpp)
void useTextApp();

//Use Music App (call from SFML.cpp)
void useMusicApp();
